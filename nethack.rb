...
class Nethack < Formula
  ...
  option "with-emacs", "Applies the nethack-el patch (If you plan to play inside emacs)"
  ...
  if build.with? "emacs"
    patch do
      url "https://raw.githubusercontent.com/dwa/nethack-el/master/enh-343.patch"
      sha256 "d416b7d0c8ff85bb9e7875563528b354056cd3b5fdbb7d09f3c36a1307df739b"
    end
  end
